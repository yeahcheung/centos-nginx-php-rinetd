...
<?php if (empty($_REQUEST['rows'])) $_REQUEST['rows'] = 60; ?>
...
<tr><td colspan='2'>
	...
	<tr>
		...
		<td><a class='item1' href='javascript:void(0)'><b>Size</b></a>
			<div class='section'>
				<a class='item2' href='<?php echo  $_SERVER['PHP_SELF']."?rows=30"?>'>30</a>
				<a class='item2' href='<?php echo  $_SERVER['PHP_SELF']."?rows=40"?>'>40</a>
				<a class='item2' href='<?php echo  $_SERVER['PHP_SELF']."?rows=50"?>'>50</a>
				<a class='item2' href='<?php echo  $_SERVER['PHP_SELF']."?rows=60"?>'>60 (default)</a>
...
<tr>
	<td colspan='2' nowrap>
	<input type="hidden" name="rows" value="<?php echo $_REQUEST['rows']; ?>">
